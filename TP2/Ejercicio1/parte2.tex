...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{images/definicionesej2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{images/conmutado.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{images/inicializarADC.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{images/mainej2.png}
